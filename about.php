        ...
        <div class="content-wrapper-scroll">
            ...
            <div class="content-wrapper">
                <div class="card-body text-center">
                    <img src="upload_img/<?php echo $major['M_img'];?>" width="15%">
                    <h1><?php echo $major['M_college'];?></h1>
                    <h2> กรณีศึกษา <?php echo $major['M_Name'];?></h2>
                    <h3>ที่อยู่  <?php echo $major['M_address'];?></h3>
                </div>
            </div>
