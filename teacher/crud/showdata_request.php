...
//$getrequestall = getrequestTOTeacher($conn,$_SESSION['data']['T_ID']);
//print_r($getrequestall);

if (isset($_GET['search']) && $_GET['search'] != '') {
    // ประกาศตัวแปรรับค่าจากฟอร์ม
    $search = "%" . $_GET['search'] . "%";
    $getrequestall = getrequestTOTeacher($conn,$_SESSION['data']['T_ID'],$search);
} else {
                    ...
                    <div class="search-container m-2">
                        <form action="showdata_room.php" method="get">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="search" placeholder="ค้นหาชื่อนักศึกษาหรือชื่อสถานประกอบการ"
                                            ...
                                            <?php else : ?>
                                                <?php foreach ($getrequestall as $requestall) : ?>
                                                    <tr>
                                                        ...
                                                        <?php if ($requestall['RE_status'] == '1' && $requestall['RE_comment'] == '') {?>
                                                            <td>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <div class="mb-12">
                                                                                    ...
                                                                                    <textarea class="form-control" id="RE_comment<?= $requestall['request_id']; ?>" placeholder="กรุณาป้อนเหตุผล" rows="3" ></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </form>
...
<!--    <script src="../../assets/vendor/apex/custom/sales/taskGraph.js"></script>-->
    ...
    <script>
        function NOTApproved(request_id) {
            var RE_comment = $('#RE_comment' + request_id).val();
            var RE_teacher_opinion = '0'
        ...
        function Approved(request_id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var RE_comment = 'อนุมัติคำร้อง';
                    var RE_teacher_opinion = '1';
                    var RE_status = '1';
