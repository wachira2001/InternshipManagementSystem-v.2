<?php
require_once 'services_student/conndb.php';
            ...
            <div class="sidebarMenuScroll">
                <ul>
                    ...
                    if ($user['S_status'] == '1') {
                        ...
                        ?>
                        <li class="">
                            <a href="crud/addFrom_company.php">
                                <i class="bi bi-file-earmark-plus"></i>
                                <span class="menu-text">ลงทะเบียนสถานประกอบการ</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="crud/addFrom_request.php">
                    ...
                    <ul class="header-actions">
                        ...
                        <li class="dropdown">
                            ...
                            <a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
                                ...
                                <!-- รูปประจำตัว -->
                                <span class="avatar">
                                    <img src="../student/img/<?php echo $user['S_img'];?>" alt="Admin Templates">
                                    <!-- สถานะออนไลน์ -->
